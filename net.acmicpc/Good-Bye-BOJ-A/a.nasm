...
main:
	...
	lea r13, [rbp + r12*4 - .sz+2]
	.l0s:
		lea rax, [rbp + rbx]
		lea rcx, [rbp + r12*4 - .sz+2]
		vmovdqu [rbp - .sz + 0x00], ymm2
		vmovdqu [rbp - .sz + 0x20], ymm2
		vmovdqu [rbp - .sz + 0x40], ymm2
		vmovdqu [rbp - .sz + 0x60], ymm2
		vmovdqu [rbp - .sz + 0x80], ymm2
		vmovdqu [rbp - .sz + 0xa0], ymm2
		vmovdqu [rbp - .sz + 0xc0], ymm2
		vmovdqu [rbp - .sz + 0xe0], ymm2
		lea rsi, [rax + r12 - .sz-1]
		lea rdi, [rax + r12*2 - .sz]
		sub rcx, rbx
		vmovdqu [rbp - .sz + 0x100], ymm2
		vmovdqu [rbp - .sz + 0x120], ymm2
		vmovdqu [rbp - .sz + 0x140], ymm2
		vmovdqu [rbp - .sz + 0x160], ymm2
		vmovdqu [rbp - .sz + 0x180], ymm2
		vmovdqu [rbp - .sz + 0x1a0], ymm2
		vmovdqu [rbp - .sz + 0x1c0], ymm2
		vmovdqu [rbp - .sz + 0x1e0], ymm2
	...
	.l1s:
		...
		vmovdqu [rbp - .sz + 0x40], ymm2
		vmovdqu [rbp - .sz + 0x60], ymm2
		lea rcx, [rbp + rdx - .sz+1]
		lea rsi, [rax + rdx - .sz+1]
		vmovdqu [rbp - .sz + 0x80], ymm2
		vmovdqu [rbp - .sz + 0xa0], ymm2
		vmovdqu [rbp - .sz + 0xc0], ymm2
		vmovdqu [rbp - .sz + 0xe0], ymm2
