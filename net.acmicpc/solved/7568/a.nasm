...
main:
	...
	.l0s:
		call ql.io.is.read_iu8_s
		mov [rbp + rbx*2 - .a-2], al
		call ql.io.is.read_iu8_s
		dec ebx
		mov [rbp + rbx*2 - .a+1], al
		jnz .l0s
	.l0e:
	...
	.l1s:
		movzx eax, byte [rbp + rbx*2 - .a-2]
		movzx edx, byte [rbp + rbx*2 - .a-2+1]
		mov ecx, r12d
		mov edi, 1

		.l1.l0s:
			cmp al, byte [rbp + rcx*2 - .a-2]
			mov esi, 1
			cmovae esi, r13d
			cmp dl, byte [rbp + rcx*2 - .a-2+1]
			cmovae esi, r13d
