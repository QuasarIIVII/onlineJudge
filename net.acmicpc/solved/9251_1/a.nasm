...
main:
	...
	mov rbx, [rel ql.io.data]
	lea rsi, [rbx + ql.io.is.offset + ql.io.is.offsetStr]

	mov rdi, [rbx + ql.io.is.offset + 0x00]
	mov byte [rdi + 1], 0
	...
	vmovdqu [rbp-0x4e0], ymm0
	vmovdqu [rbp-0x500], ymm0
	vmovdqu [rbp-0x520], ymm0
	vmovdqu [rbp-0x540], ymm0
	vmovdqu [rbp-0x560], ymm0
	vmovdqu [rbp-0x580], ymm0
	vmovdqu [rbp-0x5a0], ymm0
	vmovdqu [rbp-0x5c0], ymm0
	vmovdqu [rbp-0x5e0], ymm0
	vmovdqu [rbp-0x600], ymm0
	vmovdqu [rbp-0x620], ymm0
	vmovdqu [rbp-0x640], ymm0
	vmovdqu [rbp-0x660], ymm0
	vmovdqu [rbp-0x680], ymm0
	vmovdqu [rbp-0x6a0], ymm0
	vmovdqu [rbp-0x6c0], ymm0
	vmovdqu [rbp-0x6e0], ymm0
	vmovdqu [rbp-0x700], ymm0
	vmovdqu [rbp-0x720], ymm0
	vmovdqu [rbp-0x740], ymm0
	vmovdqu [rbp-0x760], ymm0
	vmovdqu [rbp-0x780], ymm0
	vmovdqu [rbp-0x7a0], ymm0
	vmovdqu [rbp-0x7c0], ymm0
	vmovdqu [rbp-0x7e0], ymm0
	vmovdqu [rbp-0x800], ymm0

	mov word [rbp - 0x1000], 0

	xor r8d, r8d
	lea rcx, [rbp - 0x0800] ; pre
	lea rdx, [rbp - 0x1000] ; cur
	...
	.l1s:
		...
		.l1.l0s:
			...
			; call ql.context.save
			; 	movzx edi, word [rdx + 2*r9]
			; 	movzx r12d, word [rcx + 2*r9 + 2]
			; 	call ql.io.os.write_u8_
			; 	lea rdi, [rel s2]
			; 	call ql.io.os.write_cstr
