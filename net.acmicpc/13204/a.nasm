...
main:
	...
	.l0s:
		vmovdqu [rdi        ], ymm0
		vmovdqu [rdi + 0x020], ymm0
		vmovdqu [rdi + 0x040], ymm0
		vmovdqu [rdi + 0x060], ymm0
		vmovdqu [rdi + 0x080], ymm0
		vmovdqu [rdi + 0x0a0], ymm0
		vmovdqu [rdi + 0x0c0], ymm0
		vmovdqu [rdi + 0x0e0], ymm0
		vmovdqu [rdi + 0x100], ymm0
		vmovdqu [rdi + 0x120], ymm0
		vmovdqu [rdi + 0x140], ymm0
		vmovdqu [rdi + 0x160], ymm0
		vmovdqu [rdi + 0x180], ymm0
		vmovdqu [rdi + 0x1a0], ymm0
		vmovdqu [rdi + 0x1c0], ymm0
		vmovdqu [rdi + 0x1e0], ymm0
		vmovdqu [rdi + 0x200], ymm0
		vmovdqu [rdi + 0x220], ymm0
		vmovdqu [rdi + 0x240], ymm0
		vmovdqu [rdi + 0x260], ymm0
		vmovdqu [rdi + 0x280], ymm0
		vmovdqu [rdi + 0x2a0], ymm0
		vmovdqu [rdi + 0x2c0], ymm0
		vmovdqu [rdi + 0x2e0], ymm0
		vmovdqu [rdi + 0x300], ymm0
		vmovdqu [rdi + 0x320], ymm0
		vmovdqu [rdi + 0x340], ymm0
		vmovdqu [rdi + 0x360], ymm0
		vmovdqu [rdi + 0x380], ymm0
		vmovdqu [rdi + 0x3a0], ymm0
		vmovdqu [rdi + 0x3c0], ymm0
		vmovdqu [rdi + 0x3e0], ymm0
		lea rsi, [rdi + 0x800]
		vmovdqu [rdi + 0x400], ymm0
		vmovdqu [rdi + 0x420], ymm0
		vmovdqu [rdi + 0x440], ymm0
		vmovdqu [rdi + 0x460], ymm0
		vmovdqu [rdi + 0x480], ymm0
		vmovdqu [rdi + 0x4a0], ymm0
		vmovdqu [rdi + 0x4c0], ymm0
		vmovdqu [rdi + 0x4e0], ymm0
		vmovdqu [rdi + 0x500], ymm0
		vmovdqu [rdi + 0x520], ymm0
		vmovdqu [rdi + 0x540], ymm0
		vmovdqu [rdi + 0x560], ymm0
		vmovdqu [rdi + 0x580], ymm0
		vmovdqu [rdi + 0x5a0], ymm0
		vmovdqu [rdi + 0x5c0], ymm0
		vmovdqu [rdi + 0x5e0], ymm0
		vmovdqu [rdi + 0x600], ymm0
		vmovdqu [rdi + 0x620], ymm0
		vmovdqu [rdi + 0x640], ymm0
		vmovdqu [rdi + 0x660], ymm0
		vmovdqu [rdi + 0x680], ymm0
		vmovdqu [rdi + 0x6a0], ymm0
		vmovdqu [rdi + 0x6c0], ymm0
		vmovdqu [rdi + 0x6e0], ymm0
		vmovdqu [rdi + 0x700], ymm0
		vmovdqu [rdi + 0x720], ymm0
		vmovdqu [rdi + 0x740], ymm0
		vmovdqu [rdi + 0x760], ymm0
		cmp rsi, rbp
		vmovdqu [rdi + 0x780], ymm0
		vmovdqu [rdi + 0x7a0], ymm0
		vmovdqu [rdi + 0x7c0], ymm0
		vmovdqu [rdi + 0x7e0], ymm0
		mov rdi, rsi
		jb .l0s
	.l0e:
